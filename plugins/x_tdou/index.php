...
if (! defined ( 'IN_KKFRAME' ))
	exit ( 'Access Denied!' );
$version = getSetting ( 'x_tdou', true );
$version1 = substr ( $version, 0, 5 );
$version2 = substr ( $version, 6, 8 );
echo '<h2>T豆获取记录</h2><p style="color:#757575;font-size:12px">当前插件版本：' . $version1 . ' | 更新日期：' . $version2 . ' | Designed By <a href="http://tieba.baidu.com/home/main?un=%D0%C7%CF%D2%D1%A9&fr=index" target="_blank">@星弦雪</a></p>';
?>
